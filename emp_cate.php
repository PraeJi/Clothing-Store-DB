...
<table width="1920" border="0" cellspacing="0" cellpadding="0">
  <tbody>
	...
	<table width="1920">
	<td width="491"><div class="menu" align="center"><font class="menu" face='Agency FB' color="#46352D" size="+2" > CATEGORY </font></div></td>
            ...
            <td width="1920"><table width="1700" border="1" bordercolor="#F3F1EE" bgcolor="#FFFFFF" cellpadding="5" align="center">
              <thead>
                <tr>
                  ...
                  <th><font class="text" face="Agency FB" color="#46352d" size="+2">CATEGORY NAME</font></th>
                </tr>
              </thead>
              <tbody align="center">
                <?php
