...
<table width="1920">
	...
	<div class="from" align="center">
		<form action="sb_delete_mn.php" method="post">
		...
		<label><font class="head" face='Agency FB' color="#46352D" size="+3">PRODUCT ID : </font></label>
			...
			<input class="bts-submit" type="submit" value="DELETE" required>
		...
		<?php 
						...
						$insert = mysqli_query($conn,"DELETE FROM sale_bill WHERE sale_id='$sale' AND pro_id='$id';");
