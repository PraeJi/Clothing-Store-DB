...
<div class="from" align="center">
		<form action="pd_view_one_mn.php" method="post">
		<label><font class="head" face='Agency FB' color="#46352D" size="+3">PRODUCT ID : </font></label>
			...
			<table width="1700" border="1" bordercolor="#F3F1EE" bgcolor="#FFFFFF" cellpadding="5" align="center">
              <thead>
                <tr>
              ...
              <tbody align="center">
                <?php
						$value = $_POST['id'];
						$query = " SELECT pro_id,pro_size,pro_color,pro_price,brand_name,cate_type,pro_qualtity FROM product,brand,category WHERE product.brand_id = brand.brand_id AND product.cate_id = category.cate_id AND product.pro_id='$value'";
