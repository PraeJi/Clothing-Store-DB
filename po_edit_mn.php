...
<table width="1920">
	...
	<div class="from" align="center">
		<form action="po_edit_mn.php" method="post">
		...
		<label><font class="head" face='Agency FB' color="#46352D" size="+3">BRAND NAME : </font></label>
		...
		<?php 
						...
						$insert = mysqli_query($conn,"UPDATE purchase_order SET pur_id='$pur', pro_id='$id', pur_size='$size', pur_color='$colour', pur_price='$price', pur_qualtity='$qual', pur_brand_name='$brand' WHERE pur_id='$pur' AND pro_id = '$pro_id';");
