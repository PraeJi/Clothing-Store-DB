...
<table width="1920" height="auto" border="0" cellspacing="0" cellpadding="0">
  	<tbody>
    	<tr>
			<td width="420">
				<div class="menu" align="center"><font class="menu" face='Agency FB' color="#46352D" size="+2"> - ADD - </font></div>
				<div class="containers"><form action="addUser.php" method="post">
				  ...
				  <label><font class="head" face='Agency FB' color="#46352D" size="+1">NAME : </font></label>
				  ...
				  <label><font class="head" face='Agency FB' color="#46352D" size="+1">POSITION : </font></label>
					<input class="textbox" type="text" name="pos"><br>
					...
					<?php 
						...
						$insert = mysqli_query($conn,"INSERT INTO user_system (user_id, name, password, position) VALUES ('$id', '$name', '$psw', '$pos');");
