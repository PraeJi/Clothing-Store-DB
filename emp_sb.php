...
<head>
<meta charset="utf-8">
<title>EMPLOYEE : SALE BILL</title>
<style type="text/css">
	.showid{
		margin-top: 20px;
		margin-left: 20px;
...
<table width="1920" border="0" cellspacing="0" cellpadding="0">
  <tbody>
	...
	<table width="1920">
	<td width="491"><div class="menu" align="center"><font class="menu" face='Agency FB' color="#46352D" size="+2" > SALE BILL </font></div></td>
        ...
        <tbody>
          <tr>
            <td width="1920"><table width="1700" border="1" bordercolor="#F3F1EE" bgcolor="#FFFFFF" cellpadding="5" align="center">
              ...
              <tbody align="center">
                <?php
						$query = " SELECT sale_id,pro_id,sale_size,sale_color,sale_qualtity,sale_price FROM sale_bill";
