...
<table width="1920">
	...
	<div class="from" align="center">
		<form action="po_add_mn.php" method="post">
		...
		<?php 
						...
						$insert = mysqli_query($conn,"INSERT INTO purchase_order (pur_id, pro_id, pur_size, pur_color, pur_price, pur_brand_name, pur_qualtity) VALUES ('$pur','$id', '$size', '$colour', '$price', '$brand', '$qual');");
