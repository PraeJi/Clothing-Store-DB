...
<table width="1920">
    <td width="491"><div class="menu1" align="center"><font class="menu1" face='Agency FB' color="#46352D" size="+2" > BRAND </font></div></td>
	...
	<div class="from" align="center">
		<form action="b_edit_mn.php" method="post">
		...
		<?php 
						...
						$insert = mysqli_query($conn,"UPDATE brand SET brand_id='$id', brand_name='$size'WHERE brand_id='$id';");
        ...
        <tbody>
          <tr>
            <td width="1920"><table width="1000" border="1" bordercolor="#F3F1EE" bgcolor="#FFFFFF" cellpadding="5" align="center">
              <thead>
                <tr>
                  <th><font class="text" face="Agency FB" color="#46352d" size="+2">BRAND ID</font></th>
                  <th><font class="text" face="Agency FB" color="#46352d" size="+2">BRAND NAME</font></th>
                </tr>
              </thead>
              <tbody align="center">
                <?php
                ...
                <tr>
                  <td><font class="text" face="Agency FB" color="#46352d" size="-4"><?php echo $row['brand_id'];?></font></td>
