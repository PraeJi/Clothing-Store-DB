...
<table width="1920">
	...
	<div class="from" align="center">
		<form action="pd_add_mn.php" method="post">
		...
		<?php 
						...
						$insert = mysqli_query($conn,"INSERT INTO product (pro_id, pro_size, pro_color, pro_price, pro_qualtity, brand_id, cate_id) VALUES ('$id', '$size', '$colour', '$price', '$qual', '$brand', '$cate');");
