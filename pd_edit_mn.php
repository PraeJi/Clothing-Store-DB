...
<table width="1920">
    <td width="491"><div class="menu1" align="center"><font class="menu1" face='Agency FB' color="#46352D" size="+2" > PRODUCT </font></div></td>
	...
	<div class="from" align="center">
		<form action="pd_edit_mn.php" method="post">
		...
		<label><font class="head" face='Agency FB' color="#46352D" size="+3">BRAND ID : </font></label>
			<input class="textbox" type="text" name="brand" required>
		<label><font class="head" face='Agency FB' color="#46352D" size="+3">CATEGORY ID : </font></label>
			<input class="textbox" type="text" name="cate" required>
		<label><font class="head" face='Agency FB' color="#46352D" size="+3">SIZE : </font></label>
			<input class="textbox" type="text" name="size" required><br>
		...
		<?php 
						...
						$update = mysqli_query($conn,"UPDATE product SET pro_id='$id', pro_size='$size', pro_color='$colour', pro_price='$price', pro_qualtity='$qual', brand_id='$brand', cate_id='$cate' WHERE pro_id='$id';");
