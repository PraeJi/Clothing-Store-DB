...
<head>
<meta charset="utf-8">
<title>PURCHASE ORDER : DELETE</title>
<style type="text/css">
	.showid{
		margin-top: 20px;
		margin-left: 15px;
...
<table width="1920">
	...
	<div class="from" align="center">
		<form action="po_delete_mn.php" method="post">
		...
		<?php 
						...
						$delete = mysqli_query($conn,"DELETE FROM purchase_order WHERE pur_id='$pur' AND pro_id='$id';");
