...
<table width="1920">
	...
	<div class="from" align="center">
		<form action="c_edit_mn.php" method="post">
		...
		<label><font class="head" face="Agency FB" color="#46352d" size="+3">CATEGORY TYPE</font></label>
		...
		<?php 
						...
						$insert = mysqli_query($conn,"UPDATE category SET cate_id='$id', cate_type='$size'WHERE  cate_id='$id';");
        ...
        <tbody>
          <tr>
            <td width="1920"><table width="1000" border="1" bordercolor="#F3F1EE" bgcolor="#FFFFFF" cellpadding="5" align="center">
              ...
              <tbody align="center">
                <?php
						$query = " SELECT cate_id,cate_type FROM category";
